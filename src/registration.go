...
func registerHandler(c *gin.Context) {
	...
	body := fmt.Sprintf("Please click the following link to confirm your Matcha registration: <a href=\"localhost:8080/confirm?token=%s\">Confirm</a>", confirmationToken)
